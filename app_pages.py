...
page = st.sidebar.radio("Go to", ["Dashboard", "Risk Maps", "Customer Sales"])
...
if page == "Dashboard":
    ...
    # Page 2: Risk maps for Earthquake and Flood
    st.sidebar.markdown("<h3>Select Risk Type and View</h3>", unsafe_allow_html=True)
    ...
    def create_map(view_type, risk_type):
        ...
        if view_type == "State":
            folium.Choropleth(
                ...
                fill_color="RdYlGn_r",  # Red for high risk, Green for low risk
                fill_opacity=0.7,
                line_opacity=0.2,
